...
public class Camera_Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Mouse_Location = new Vector3(
            -Mouse_Location.y * Camera_Sensitivity,
            Mouse_Location.x * Camera_Sensitivity,
            0
        );

        Mouse_Location = new Vector3(
            transform.eulerAngles.x + Mouse_Location.x,
            transform.eulerAngles.y + Mouse_Location.y,
            0
        );
